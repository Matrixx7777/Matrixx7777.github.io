$(document).ready(function() {
   const apiRoot = 'https://desolate-brushlands-65059.herokuapp.com/v1/'; //task/
   const trelloApiRoot = 'https://desolate-brushlands-65059.herokuapp.com/v1/trello/';
   ...
   function getAllAvailableBoards(callback, callbackArgs) {
      var requestUrl = trelloApiRoot + 'boards';	//'getTrelloBoards'
   ...
   function getAllTasks() {
      const requestUrl = apiRoot + 'tasks';		//'getTasks'
   ...
   function handleTaskUpdateRequest() {
      ...
      var requestUrl = apiRoot + 'tasks';		//'updateTask'
   ...
   function handleTaskDeleteRequest() {
      var parentEl = $(this).parents('[data-task-id]');
      var taskId = parentEl.attr('data-task-id');
      var requestUrl = apiRoot + 'tasks';		//'deleteTask'
   ...
   function handleTaskSubmitRequest(event) {
      ...
      var requestUrl = apiRoot + 'tasks';		//'createTask'
   ...
   function handleCardCreationRequest(event) {
      var requestUrl = trelloApiRoot + 'cards';		//'createTrelloCard'
